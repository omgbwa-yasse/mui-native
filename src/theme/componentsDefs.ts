...
import type { DrawerLayoutAndroidProps } from '../components/DrawerLayoutAndroid/types';
import type { FABProps } from '../components/FAB/types';
import type { TransitionBaseProps } from '../components/Fade/types';
import type { FlatListBaseProps } from '../components/FlatList/types';
...
import type { PressableProps } from '../components/Pressable/types';
import type { RadioGroupProps } from '../components/RadioButton/types';
import type { RatingProps } from '../components/Rating/types';
import type { RefreshControlProps } from '../components/RefreshControl/types';
import type { SafeAreaViewProps } from '../components/SafeAreaView/types';
import type { ScrollViewProps } from '../components/ScrollView/types';
import type { SectionListBaseProps } from '../components/SectionList/types';
...
import type { TouchableHighlightProps } from '../components/TouchableHighlight/types';
import type { TouchableOpacityProps } from '../components/TouchableOpacity/types';
import type { ImageBackgroundProps } from '../components/ImageBackground/types';
import type { VirtualizedListBaseProps } from '../components/VirtualizedList/types';
...
export interface ComponentPropsMap {
  ...
  SectionList: SectionListBaseProps;
  ...
  VirtualizedList: VirtualizedListBaseProps;
  View: ViewProps;
